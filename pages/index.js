              ...
              <div className="row">
                <div className="col-lg-7">
                  ...
                  <p className="text-body-lead-large color-white mt-30 pr-40">
                    Online or In-Person English classes & teachers for private
                    and group lessons
                  </p>
                  <div className="mt-40">
                    <button
                  ...
                  <div className="mt-60">
                    <div className="row">
                      ...
                      <div className="col-lg-3 col-sm-4 col-4">
                        <h3 className="text-heading-2 color-white mb-15"></h3>
                        <p className="text-body-normal color-gray-300">
                          One on One Lessons & Group Classes
                        </p>
                      </div>
                      <div className="col-lg-3 col-sm-4 col-4">
                        <h3 className="text-heading-2 color-white mb-15"></h3>
                ...
                <div className="list-icons mt-50">
                  <div className="item-icon none-bd hover-up">
                    ...
                    <p className="text-body-excerpt color-gray-600 mt-15">
                      ...
                      classes, one on one sessions, and both in-person and
                      virtual learning.
                    </p>
                  </div>
                  <div className="item-icon none-bd hover-up">
