                                            ...
                                            <div className="row">
                                                <div className="col-xl-6 col-lg-12">
                                                    <div className="img-news">
                                                        <Link href="/blog-single"><a><img src="/assets/imgs/page/blog/1/img-1.png" alt="English Horizons" />
                                                        </a></Link>
                                                    </div>
                                                </div>
                                                <div className="col-xl-6 col-lg-12">
                                                    <div className="right-news card-grid-style-4 mb-0"><span className="tag-dot">Marketing Event</span>
                                                        ...
                                                        <div className="blog-img-user">
                                                            <div className="img-user img-user-round"><img src="/assets/imgs/page/blog/2/user-1.png" alt="English Horizons" /></div>
